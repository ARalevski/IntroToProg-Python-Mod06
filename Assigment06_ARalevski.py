...
strFileName = "/Users/aralevski/Documents/_PythonClass/Module06/Assignment06/ToDoFile.txt"  # The name of the data file
...
class IO:
    ...
    def input_new_task_and_priority():
        strTask = str(input('Enter a Task: ').lower())
        strPriority = str(input('Enter a Priority Level: ').lower())
        return strTask, strPriority

    @staticmethod
    def input_task_to_remove():
        strTask = str((input('Which task would you like to remove?: ').lower().strip()))
        return strTask
